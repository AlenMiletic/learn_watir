Feature: Adopting puppies
    ...
    Scenario: Adopting one puppy
        ...
        And I enter "Alen" in the name field
        And I enter "ul.Grabrovec 151" in the address field
        And I enter "alen.miletic6@gmail.com" in the email field
        And I select "Credit card" from the pay dropdown
    ...
    Scenario: Verifying the shopping cart with one puppy
        When I click the View Details button for "Brook"
        And I click the Adopt Me button
